...
const SimpleAddToCartButton: React.FC<SimpleAddToCartButtonProps> = ({ product, className = '' }) => {
  ...
  const handleAddToCart = () => {
    console.log('=== SimpleAddToCartButton: INICIO ===');
    console.log('SimpleAddToCartButton: Botón clickeado para producto:', product.id);
    
    setIsAdding(true);
    
    // Crear el item exactamente como en el test
    const newItem = {
      id: product.id,
      name: product.name,
      price: product.price,
    ...
    console.log('SimpleAddToCartButton: Item a agregar:', newItem);
    
    // Usar el hook del store para que se re-renderice
    addItem(newItem);
    
    console.log('SimpleAddToCartButton: Item agregado al store');
    ...
    setIsAdding(false);
    console.log('=== SimpleAddToCartButton: FIN ===');
  };
